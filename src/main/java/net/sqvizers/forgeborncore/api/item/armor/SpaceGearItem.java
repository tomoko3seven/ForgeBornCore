...
public class SpaceGearItem extends ArmorComponentItem
        implements BotariumFluidItem<WrappedItemFluidContainer> {

    protected final long tankSize;

    public SpaceGearItem(ArmorMaterial material, Type type, long size, Properties properties) {
    ...
    public SpaceGearItem setArmorLogic(IArmorLogic armorLogic) {
        return (SpaceGearItem) super.setArmorLogic(armorLogic);
    }
    ...
    public long getOxygenAmount(Entity entity) {
        ...
        if (!(stack.getItem() instanceof SpaceGearItem suit)) return 0;
